package br.com.dio.collection.streamsAPI;

/*Given the  id and contact, create a dictionary and
order it  (Nome id - Nome contato);
...
public class RefactoringMapOrdination {
